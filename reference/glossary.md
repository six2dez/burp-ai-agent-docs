...
Right-click action that runs an active AI scan scoped to a single parameter, header, JSON field, XML element, or path-segment ID under the request-editor selection. See [Insertion Point Scan](../user-guide/insertion-point-scan.md).
