...
<!-- TODO: screenshot of Settings → AI Backend with Perplexity selected, showing the 5 Perplexity fields populated (URL, Model, API Key masked, Extra Headers empty, Timeout 60). Save as .gitbook/assets/backend-perplexity.png and replace this marker with:
![Screenshot: Perplexity backend settings](../.gitbook/assets/backend-perplexity.png)
-->
